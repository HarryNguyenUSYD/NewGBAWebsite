...
const ListSection = ({ clients, page } : { clients: ClientsTableType | null, page: number }) => {
    ...
    return (
        <div className="w-full h-auto mb-10 flex flex-col justify-center items-center">
            <div className="w-[80vw] h-auto bg-white flex flex-col justify-start items-center gap-20">
                {clients?.slice((page - 1) * ITEMS_PER_PAGE, (page - 1) * ITEMS_PER_PAGE + ITEMS_PER_PAGE).map((client, i) => (
                    <div
                        key={`client_${i}`}
                        className="relative w-full h-[80vh] flex flex-col justify-center items-center gap-10"
                    >
                        <div className="relative w-full h-1/2 bg-white flex flex-col justify-center items-center gap-2">
                            <Image
