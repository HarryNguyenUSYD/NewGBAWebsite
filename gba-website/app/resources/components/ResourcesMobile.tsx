...
const HolidaySection = () => {
    ...
    return (
        <div className="w-full h-auto flex flex-col justify-center items-center gap-10 my-10">
            <p className={`${titleFont.className} text-6xl text-black`}>
            ...
            <div className="w-full h-auto flex flex-col justify-start items-center gap-20">
                {holidayImages.map((image, i) => (
                    <div
                        ...
                        className="w-[50vw] h-auto p-10 border-4 border-black flex flex-col justify-center items-center gap-5"
                    >
                        <Image
                            src={image.src}
                            width={1920}
                        ...
                        />
                        <p className="text-4xl italic text-black my-5">
